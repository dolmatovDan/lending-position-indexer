...
On-chain ценообразование: цены токенов берутся исключительно из on-chain источников (протокольные оракулы, Chainlink, pool pricing), разрешаются внутри адаптеров протоколов с общими helper'ами нормализации в `internal/pricing`.
