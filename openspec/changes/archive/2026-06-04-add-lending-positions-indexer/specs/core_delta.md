# Delta: Core (blocks processor, positions manager, модель Position)

**Change ID:** `add-lending-positions-indexer`
**Affects:** `internal/clients/ethnode`, `internal/processors/blocks`, `internal/managers/positions`, `internal/models`, `cmd/positions`
